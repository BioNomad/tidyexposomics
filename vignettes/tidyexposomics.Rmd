...
We can then associate these exposome scores with the outcome of interest using the `associate_exposure_outcome` function, just like we did before.
...
The `run_create_network` function is used to create a network of exposures and omics features. The correlation results are used to create the network. The `cor_results` argument can be:

- `deg_exp_cor`: Correlation results between differentially abundant features and exposures (results from running `correlate_exposures_degs`).

- `factor_exp_cor`: Correlation results between factors and exposures (results from running `correlate_exposures_factors`).

- `omic_exp_cor`: Correlation results between omics features and exposures (results from running `correlate_exposures_omics`).
...
- `correlate_exposures_degs`: Correlation between differentially abundant features and exposures. Meaning that connections between exposures and between omics will be missing.

- `correlate_exposures_factors`: Correlation between factors and exposures. Meaning that connections between factors and between omics will be missing.

- `correlate_exposures_omics`: Correlation between omics features and exposures. Where there will be connections between omics and features.
