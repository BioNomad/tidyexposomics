...
```{r command_str,echo = FALSE, message=FALSE,fig.align='center'}
...
```{r ontology_app,message=FALSE,warning=FALSE,eval=FALSE}
...
```{r ontology_app_img,echo = FALSE, message=FALSE, out.width="150%",fig.align='center'}
...
We are going to start by loading in example data pulled from the [ISGlobal Exposome Data Challenge 2021](https://doi.org/10.1016/j.envint.2022.107422) (Maitre et al., 2022). Specifically, we will examine how exposures and omics features relate to asthma status.

```{r silent_load,echo=FALSE,warning=FALSE,message=FALSE}
# Load Libraries
library(tidyverse)
library(tidyexposomics)
download_dataset("expom_1")
download_dataset("annotated_cb")
...
```{r low_ses_filter,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r exp_vars,warning=FALSE,message=FALSE,eval=FALSE}
# Grab exposure variables
exp_vars <- annotated_cb |>
    filter(category %in% c(
        "exposure to oxygen molecular entity",
...
```{r missing_bar,warning=FALSE,message=FALSE,fig.height=4.5,fig.width=6,eval=FALSE}
expom_1 |>
    plot_missing(
        plot_type = "summary",
        threshold = 0
...
```
```{r missing_bar_img,echo = FALSE, message=FALSE,fig.align='center'}
knitr::include_graphics("./missing_bar.png")
```

Here we see that there are 10 variables in the exposure data that are missing data. Let’s take a look at them:

```{r missing_bar_lollipop,warning=FALSE,message=FALSE,fig.height=4,fig.width=4,eval=FALSE}
expom_1 |>
    plot_missing(
        plot_type = "lollipop",
        threshold = 0,
...
```{r missing_bar_lollipop_img, echo = FALSE, message=FALSE,fig.align='center'}
knitr::include_graphics("./missing_lollipop.png")
```
...
```{r filt_missing, warning=FALSE,message=FALSE,eval=FALSE}
...
```{r impute_missing,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r filter_omics,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r normality_check,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r norm_plot,warning=FALSE,message=FALSE,fig.width=4,fig.height=4}
expom_1 |>
...
```{r pca,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r pca_plot,warning=FALSE,message=FALSE,fig.align='center',fig.width=9,fig.height=7,eval=FALSE}
# Plot principal component analysis results
expom_1 |>
    plot_pca()
```

```{r pca_plot_img, echo = FALSE, message=FALSE,fig.align='center'}
...
```{r filt_outliers,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r corr_pcs,warning=FALSE,message=FALSE,eval=FALSE}
expom_1 <- expom_1 |>
    run_correlation(
        feature_type = "pcs",
        exposure_cols = exp_vars,
...
```{r plot_pc_corr,warning=FALSE,message=FALSE,fig.width=7,fig.height=4}
expom_1 |>
...
```{r exp_sum, warning=FALSE,message=FALSE,fig.width=6,fig.height=4}
...
```{r plot_aerosol,fig.width=6.5,fig.height=3.5,message=FALSE,warning=FALSE}
# Plot exposure data
expom_1 |>
    plot_exposures(
...
```{r sample_clusters,warning=FALSE,message=FALSE,eval=FALSE}
# Sample clustering
expom_1 <- expom_1 |>
    run_cluster_samples(
        exposure_cols = exp_vars,
...
```{r plot_sample_clusters,message=FALSE,warning=FALSE,fig.height=8,fig.width=12,out.width="170%"}
...
```{r correlate_exposures,message=FALSE,warning=FALSE,eval=FALSE}
expom_1 <- expom_1 |>
    run_correlation(
...
```{r exposure_circos_corr,warning=FALSE,message=FALSE,fig.height=10,fig.width=10,fig.align='center'}
expom_1 |>
...
```{r assoc_exposures,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r plot_exposure_assoc,warning=FALSE,message=FALSE,fig.height=6,fig.width=5,fig.align='center'}
expom_1 |>
    plot_association(
        subtitle = paste(
            "Covariates:",
...
```{r associate_top_omics,warning=FALSE,message=FALSE,fig.height=3,fig.width=4.5,fig.align='center',eval=FALSE}
# Perform ExWAS Analysis
expom_1 <- expom_1 |>
    run_association(
        outcome = "hs_asthma",
...
```{r plot_manhattan,warning=FALSE,message=FALSE,fig.height=7,fig.width=5,fig.align='center'}
expom_1 |>
    plot_manhattan(
        min_per_cat = 0,
...
```{r calc_exposome,warning=FALSE,message=FALSE,results = 'hide',eval=FALSE}
...
```{r associate_exposome_score,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r plot_exposome_scores,warning=FALSE,message=FALSE,fig.height=3,fig.width=5,fig.align='center'}
expom_1 |>
    plot_association(
...
```{r diff_abundance,warning=FALSE,message=FALSE,results = 'hide',eval=FALSE}
...
```{r volcano_plot,warning=FALSE,message=FALSE,fig.height=4,fig.width=7,fig.align='center'}
...
```{r sensitivity_analysis,message=FALSE,warning=FALSE,results = 'hide',eval=FALSE}
...
```{r plot_stability_score,warning=FALSE,message=FALSE,fig.align='center',fig.width=8,fig.height=3}
...
- `DIABLO`: DIABLO: Supervised multi-block PLS for outcome-aligned latent factors implemented using the [`mixOmics` package](https://www.bioconductor.org/packages/devel/bioc/html/mixOmics.html) (mixOmics).
...
```{r multiomics_int,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r factor_summary,warning=FALSE,message=FALSE,fig.height=2,fig.width=5,fig.align='center'}
...
```{r associate_factors,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r plot_associate_factors,warning=FALSE,message=FALSE,fig.width=5,fig.height=5}
expom_1 |>
    plot_association(
        source = "factors",
...
```{r extract_top_features,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r plot_top_features,warning=FALSE,message=FALSE,fig.height=8,fig.width=6,fig.align='center'}
...
```{r factor_overlap,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r omics_exp_corr,warning=FALSE,message=FALSE,eval=FALSE}
...
```{r exp_omic_corr_summary,message=FALSE,warning=FALSE,fig.height=9,fig.width=13,fig.align='center'}
expom_1 |>
...
```{r exposure_shared_corr,fig.width=10,fig.height=9,message=FALSE,warning=FALSE}
...
```{r create_network,fig.width=10,fig.height=7,message=FALSE,warning=FALSE,eval=FALSE}
expom_1 <- expom_1 |>
    run_create_network(
...
```{r plot_network,fig.width=10,fig.height=5,message=FALSE,warning=FALSE,eval=FALSE}
expom_1 |>
    plot_network(
        network = "omics",
        top_n_nodes = 100,
...
```{r plot_network_img,echo = FALSE, message=FALSE,fig.align='center'}
knitr::include_graphics("./exp_omic_net.png")
```
...
```{r exposure_impact,message=FALSE,warning=FALSE,eval=FALSE}
...
```{r plot_exposure_impact,fig.width=6,fig.height=7,message=FALSE,warning=FALSE,fig.align='center'}
...
```{r enrichment_summary,warning=FALSE,message=FALSE, fig.width=13,fig.height=6}
expom_1 |>
    plot_enrichment(
...
```{r enrichment_dotplot,warning=FALSE,message=FALSE,fig.height=11,fig.width=11}
expom_1 |>
    plot_enrichment(
        feature_type = "omics_cor",
        plot_type = "dotplot",
...
```{r enrichment_term_network,warning=FALSE,message=FALSE,fig.width=6,fig.height=5}
expom_1 |>
    plot_enrichment(
        feature_type = "omics_cor",
        plot_type = "network",
...
```{r enrichment_heatmap,warning=FALSE,message=FALSE,fig.height=3,fig.width=8}
expom_1 |>
    plot_enrichment(
        feature_type = "omics_cor",
        go_groups = "Group_5",
...
```{r enrichment_cnetplot,warning=FALSE,message=FALSE,fig.width=6,fig.height=6}
expom_1 |>
    plot_enrichment(
        feature_type = "omics_cor",
        go_groups = "Group_5",
...
```{r pivot_sample,warning=FALSE,message=FALSE,fig.height=3,fig.width=6,fig.align='center'}
...
```{r pivot_sample_example,warning=FALSE,message=FALSE,fig.height=3,fig.width=6,fig.align='center'}
expom_1 |>
    pivot_sample() |>
...
```{r pivot_feature,warning=FALSE,message=FALSE,fig.height=3,fig.width=6,fig.align='center'}
...
```{r pivot_feature_example,warning=FALSE,message=FALSE,fig.height=3,fig.width=6,fig.align='center'}
...
```{r pivot_exp,warning=FALSE,message=FALSE,fig.height=3,fig.width=6,fig.align='center'}
# Pivot experiment data to a tibble
expom_1 |>
    pivot_exp(
        exp_name = "Methylation",
        features = "cg25330361"
    ) |>
    head()
```
...
```{r pivot_exp_example,warning=FALSE,message=FALSE,fig.height=4,fig.width=4,fig.align='center'}
...
```{r pipeline_summary,fig.width=5,fig.height=15,warning=FALSE}
...
```{r save_results,warning=FALSE,message=FALSE,eval=FALSE}
