...
```{r,warning=FALSE,message=FALSE,fig.height=4.5,fig.width=6,eval=FALSE}
expom_1 |>
    plot_missing(
        plot_type = "summary",
        threshold = 0
...
```{r,warning=FALSE,message=FALSE,fig.height=4,fig.width=4,eval=FALSE}
expom_1 |>
    plot_missing(
        plot_type = "lollipop",
        threshold = 0,
...
```{r,warning=FALSE,message=FALSE,fig.align='center',fig.width=9,fig.height=7,eval=FALSE}
...
```{r,warning=FALSE,message=FALSE,fig.height=3,fig.width=4.5,fig.align='center',eval=FALSE}
# Perform ExWAS Analysis
expom_1 <- expom_1 |>
    run_association(
        outcome = "hs_asthma",
