...
```{r,warning=FALSE,message=FALSE,fig.width=6,fig.height=4,out.width="90%",fig.align='center'}
...
```{r,message=FALSE,warning=FALSE,fig.height=5,fig.width=11,out.width="170%"}
